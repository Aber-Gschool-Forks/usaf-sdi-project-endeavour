    ...
    <div>
      <Header />
        <section className="aboutBody">
          ...
          <ul className="authorList">This website was made possible by the hard working crews that flew the Space Shuttle Endeavour (pronouced En-Dave-Eeyore).  To honor them, we have created
          ...
          beer while you are traveling.</ul>
